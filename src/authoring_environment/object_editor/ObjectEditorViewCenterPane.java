...
public class ObjectEditorViewCenterPane {
	private ResourceBundle centerResources = ResourceBundle
			.getBundle("authoring_environment/object_editor/CenterPaneResources");
	...
	public Group init() {
		...
		Canvas c = new Canvas(Integer.parseInt(centerResources.getString("canvasWidth")),
				Integer.parseInt(centerResources.getString("canvasHeight")));
	...
	public Image addSprite(String s) {
		try {
			if (s == null) {
				return new Image(
						getClass().getClassLoader().getResourceAsStream(centerResources.getString("nullImage")),
						Integer.parseInt(centerResources.getString("defaultSize")),
	...
	private void draw(String s) {
		centerGC.clearRect(0, 0, Integer.parseInt(centerResources.getString("canvasWidth")),
				Integer.parseInt(centerResources.getString("canvasHeight")));
		sprite = addSprite(s);
