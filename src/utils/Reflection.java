...
public class Reflection {
     ...
     */
    public static Object createInstance (Class<?> type) throws ReflectionException {
    	String name = type.getName();
        try {
            return type.newInstance();
        } catch (Exception e) {
            throw new ReflectionException(e, "No public default constructor for %s", name);
        }
    }
    
    public static Object createInstance(String className, Object... args) throws ReflectionException {
    	try {
     ...
     */
    public static Object createInstance (Class<?> type, Object... args) throws ReflectionException {
        String name = type.getName();
    	try {
            Class<?> c = type;
