...
In terms of the backend of the authoring environment, the main purpose of this part of the project is to get the data from the front-end of the authoring environment 
